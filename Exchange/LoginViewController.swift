...
class LoginViewController: UIViewController, UITextFieldDelegate{
    ...
    let logoContainerView: UIView = {
        ...
        logoImageView.image = UIImage(named:"xchangelogo.png")
        ...
        nameImageView.image = UIImage(named:"xchange.png")
        nameImageView.contentMode = .scaleAspectFill

        view.addSubview(nameImageView)
        nameImageView.anchor(top: nil, left: nil, bottom: nil, right: nil, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 200, height: 50)
        nameImageView.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        nameImageView.topAnchor.constraint(equalTo: logoImageView.bottomAnchor, constant: 100).isActive = true
